...
//    public List<MusicDto> findByCriteria(MusicSearchCriteriaDto musicSearchCriteriaDto) {
//        List<Music> musicList = musicRepository.findAll(createFromCriteria(musicSearchCriteriaDto));
//        log.info("IN findAll - the number of tracks according to these criteria = {}", musicList.size());
//        return musicMapper.mapFromEntity(musicList);
//    }
