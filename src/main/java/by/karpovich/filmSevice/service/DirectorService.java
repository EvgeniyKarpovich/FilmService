...
//    public List<DirectorDto> findByCriteria(DirectorSearchCriteriaDto directorSearchCriteriaDto) {
//        List<Director> directorList = directorRepository.findAll(createFromCriteria(directorSearchCriteriaDto));
//        log.info("IN findAll - the number of directors according to these criteria = {}", directorList.size());
//        return directorMapper.mapFromEntity(directorList);
//    }
